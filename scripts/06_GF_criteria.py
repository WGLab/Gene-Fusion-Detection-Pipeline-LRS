...
artifact_filter_path = sys.argv[3] # path/to/06_GF_criteria
...
artifact_filter_longgf_output = artifact_filter_path + sample_number + "_longgf.tsv"



# JAFFA
input_jaffa = sys.argv[5]


# FUSION SEEKER 
input_fusion_seek = sys.argv[6] 
...
output_file = input_path + "longgf_summary.tsv"
all_output_filenames = []  

# Summary file
combine_longgf_outputs(longgf_parameters, input_path, output_file, all_output_filenames)
